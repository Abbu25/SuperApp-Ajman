...
WebUI.callTestCase(findTestCase('Utilities/Account Selection Based on Currency'), [('currency') : currency], FailureHandling.CONTINUE_ON_FAILURE)
...
if (currency == 'AED') {
    ...
    Mobile.tap(findTestObject('3.Payments/Payment Success page/Button_Back To Payment'), 0 //Mobile.tapAtPosition(137, 771)
        )
} else {
    Mobile.waitForElementPresent(findTestObject('3.Payments/Payment Confirmation Page/Button_Confirm'), 0)
