...
Mobile.waitForElementPresent(findTestObject('2.Dashboard/Profile Settings/Icon_Home'), 60)

Mobile.tap(findTestObject('2.Dashboard/Profile Settings/Icon_Home'), 0)

Mobile.waitForElementPresent(findTestObject('2.Dashboard/Accounts/AccountDetails'), 0)
