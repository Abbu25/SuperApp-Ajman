...
class Kat {
	 ...
	 */
	@Keyword
	def String getCurrentSessionMobileDriver() {
		AppiumDriver driver= MobileDriverFactory.getDriver();
		String name = driver.findElement(By.xpath("//android.widget.Button[contains(@content-desc, 'a New Customer')]")).getAttribute("contentDescription")
		return name;
	}
}